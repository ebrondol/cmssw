...
class GeometricDet {
 public:
  ...
  typedef enum GDEnumType {unknown=100, Tracker=0, PixelBarrel=1, PixelEndCap=2,
			   ...
			   PixelPhase1Barrel=101, PixelPhase1EndCap=102, PixelPhase1Disk=117,
			   OTPhase2EndCap=204, OTPhase2Barrel=205, OTPhase2Layer=208,
			   PixelPhase2EndCap=202, OTPhase2Wheel=209, OTPhase2Rod=211, OTPhase2Stack=215,
			   PixelPhase2FullDisk=217, PixelPhase2ReducedDisk=227 } GeometricEnumType;
  /**
