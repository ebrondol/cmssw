...
namespace GeomDetEnumerators {
  ...
  enum SubDetector {PixelBarrel, PixelEndcap, TIB, TOB, TID, TEC, CSC, DT, RPCBarrel, RPCEndcap, GEM, ME0, P2OTB, P2OTEC, P1PXB, P1PXEC, P2PXB, P2PXEC, invalidDet};
  // gives subdetId in DetId conrrepsonding to the above
  constexpr unsigned int subDetId[19]={1,2,3,5,4,6, 0, 0,0,0,0,0,5,4,1,2,1,2,0}; // don't ask, don't ask, simply do not ask!
  ...
  constexpr SubDetector subDetGeom[19]={PixelBarrel, PixelEndcap, TIB, TOB, TID, TEC, invalidDet, invalidDet, invalidDet, invalidDet, invalidDet, invalidDet, TOB, TID, PixelBarrel, PixelEndcap, PixelBarrel, PixelEndcap, invalidDet};
