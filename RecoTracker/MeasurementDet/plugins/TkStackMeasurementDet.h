...
class TkStackMeasurementDet GCC11_FINAL : public MeasurementDet {
 ...
 public:
  ...
  const TkPhase2MeasurementDet* lowerDet() const{ return theInnerDet;}
  const TkPhase2MeasurementDet* upperDet() const{ return theOuterDet;}
 ...
 private:
  ...
  const TkPhase2MeasurementDet*       theInnerDet;
  const TkPhase2MeasurementDet*       theOuterDet;
