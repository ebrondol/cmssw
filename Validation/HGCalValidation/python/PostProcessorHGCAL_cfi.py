...
iterations = ['Dummy','TrkEM','EM','Trk','HAD','Merge']
...
subdirs_1SimCl = [subdir.replace('HGCalValidator', 'HGCalValidator_1SimCl') for subdir in subdirs]
postProcessorHGCALmulticlusters_1SimCl = postProcessorHGCALmulticlusters.clone(
  subDirs = subdirs_1SimCl
)
