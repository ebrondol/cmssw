#ifndef RecoLocalTracker_SiStripRecHitConverter_Phase2StripCPEgeometric_H
#define RecoLocalTracker_SiStripRecHitConverter_Phase2StripCPEgeometric_H
...
class Phase2StripCPEgeometric : public StripCPE
{
 ...
 public:
  ...
  StripClusterParameterEstimator::LocalValues
    localParametersForPhase2( const Phase2TrackerCluster1D&, const GeomDetUnit&, const LocalTrajectoryParameters&) const;
