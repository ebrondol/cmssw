#include "RecoLocalTracker/SiStripRecHitConverter/interface/Phase2StripCPEgeometric.h"
#include "RecoLocalTracker/SiStripRecHitConverter/interface/CrosstalkInversion.h"
#include "Geometry/CommonTopologies/interface/StripTopology.h"
#include <numeric>

StripClusterParameterEstimator::LocalValues Phase2StripCPEgeometric::
...
StripClusterParameterEstimator::LocalValues Phase2StripCPEgeometric::
localParametersForPhase2( const Phase2TrackerCluster1D& cluster, const GeomDetUnit& det, const LocalTrajectoryParameters& ltp) const {
...
stats_t<float> Phase2StripCPEgeometric::
...
stats_t<float> Phase2StripCPEgeometric::
geometric_position(const Phase2StripCPEgeometric::WrappedCluster& wc, const stats_t<float>& proj) const {
...
Phase2StripCPEgeometric::WrappedCluster::
...
inline
void Phase2StripCPEgeometric::WrappedCluster::
...
inline
float Phase2StripCPEgeometric::WrappedCluster::
middle() const
{ return (first-clusterFirst) + N/2.;}

inline
stats_t<float> Phase2StripCPEgeometric::WrappedCluster::
centroid() const {
...
inline
bool Phase2StripCPEgeometric::WrappedCluster::
deformed() const
...
inline
int Phase2StripCPEgeometric::WrappedCluster::
sign() const
