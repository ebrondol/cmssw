...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:step2_flat_newDigis.root'),
...
process.FEVTDEBUGHLToutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:step3_flat_VHs.root'),
...
process.TFileService = cms.Service('TFileService',
    fileName = cms.string('file:vh_validation_flat.root')
)
...
from SLHCUpgradeSimulations.Configuration.combinedCustoms import cust_2023Muon,cust_removeTTI 
