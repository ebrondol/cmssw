...
#--------------import os
process = cms.Process('AnalyzerClusterStubNew')
...
# load the analyzer
#################################################################################################
process.AnalyzerClusterStubNew = cms.EDAnalyzer("AnalyzerClusterStubNew",
...
#  fileName = cms.string('file:AnalyzerClusterStubNew_ExtendedPhase2TkBE5D_MuonPU140.root')
#  fileName = cms.string('file:AnalyzerClusterStubNew_ExtendedPhase2TkBE5D_Pion.root')
  fileName = cms.string('file:AnalyzerClusterStub.root')
#  fileName = cms.string('file:AnalyzerClusterStubNew_ExtendedPhase2TkBE5D_DYTauTau.root')
)

#################################################################################################
# define the final path to be fed to cmsRun
#################################################################################################
process.p = cms.Path( process.AnalyzerClusterStubNew )
